...
public class GetData2e {
	...
	public static void getdata(String txt) {
	    ...
	    String re11="([a-z])";	// Any Single Word Character (Not Whitespace) 1
	    String re12="([a-z])";	// Any Single Word Character (Not Whitespace) 2
	    String re13="([a-z])";	// Any Single Word Character (Not Whitespace) 3
	    ...
	    if (m.find())
	    {
	        ...
	        list.add(d1.toString()+d2.toString()+d3.toString()+d4.toString()+d5.toString()+d6.toString()+d7.toString()+d8.toString()+
	        		d9.toString()+d10.toString()+ "-" +c1.toString()+w1.toString()+w2.toString()+w3.toString());
	    }else{
